...
export default function EditGymPage() {
  ...
  useEffect(() => {
    // Load gym data - in real app, fetch from API
    setFormData({
      name: sampleGym.name,
      location: sampleGym.location,
      openTime: sampleGym.openTime,
      closeTime: sampleGym.closeTime,
      genderAcceptance: sampleGym.genderAcceptance,
      size: sampleGym.size,
      description: sampleGym.description,
    })
    setSelectedAmenities(sampleGym.amenities)
    setUploadedImages(sampleGym.images)
    setSelectedPricingOptions(sampleGym.pricingOptions)
    setPricingData(sampleGym.pricing)
  }, [])
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Update your gym listing</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Update the basic details about your gym</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Update your gym's schedule and policies</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Update amenities available at your gym</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Update your gym's pricing options</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Update photos of your gym</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
