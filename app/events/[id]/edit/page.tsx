...
export default function EditEventPage() {
  ...
  useEffect(() => {
    // In real app, fetch event data by ID
    setFormData({
      ...
      genderAcceptance: mockEvent.genderAcceptance,
      ...
      pricePerAttendee: mockEvent.pricePerAttendee,
      amenities: mockEvent.amenities,
    })
    setImages(mockEvent.images)
  }, [params.id])
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    console.log("Updated event data:", { ...formData, images })
